...
public:
   ...
   poisson_degree_distribution (const poisson_degree_distribution&) = delete;
   poisson_degree_distribution& operator=(const poisson_degree_distribution&) = delete;
   poisson_degree_distribution& operator=(poisson_degree_distribution&&) = delete;
